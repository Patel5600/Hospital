...
export default function DoctorLayout() {
    ...
    const navigation = [
        ...
        // { name: 'Patients', href: '/doctor/patients', icon: User }, // Maybe later
    ];
    ...
    return (
        <div className="flex h-screen bg-gray-50">
            ...
            <div className="flex flex-col w-64 bg-white border-r">
                <div className="flex items-center justify-center h-16 border-b bg-teal-600">
                ...
                <div className="p-4 border-b bg-teal-50">
                    <div className="flex items-center">
                        <div className="flex-shrink-0">
                            <div className="w-10 h-10 bg-teal-200 rounded-full flex items-center justify-center text-teal-800 font-bold text-lg">
                                {user?.name?.charAt(0)}
                            </div>
                        </div>
                        <div className="ml-3">
